...
public class AnonymousProgressBarUi extends BasicProgressBarUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new AnonymousProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        if (c.isOpaque()) g.fill(area);

        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) AnonymousIcons.ANONYMOUS_ICON) : ((ScalableIcon) AnonymousIcons.ANONYMOUS_R_ICON);
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        g2.setPaint(getProgressBarPaint(h));

        AnonymousIcons.ANONYMOUS_ICON.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
        ...
        // Deal with possible text painting
        if (progressBar.isStringPainted()) paintString(g, b.left, b.top, barRectWidth, barRectHeight, amountFull, b);
    ...
    private LinearGradientPaint getProgressBarPaint(int height) {
